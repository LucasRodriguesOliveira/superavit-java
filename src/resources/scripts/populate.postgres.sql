...
-- Estados Brasileiros
INSERT INTO estado (id, nome, sigla, codigoNacao) VALUES
(1, 'Acre', 'AC', 1),
(2, 'Alagoas', 'AL', 1),
(3, 'Amazonas', 'AM', 1),
(4, 'Amapá', 'AP', 1),
...
-- Encontrei por acaso esta lista completa de todas as cidades do brasil
...
SELECT insereUsuario('Lucas Oliveira', '11122233344', '', 'lucas@email.com', 'admin', 1, 1);
SELECT insereUsuario('Superavit', '', '', 'superavit@email.com', 'admin', 2, 1);
SELECT insereUsuario('João da Silva', '12345678900', '', 'joao@email.com', 'j.silva', 1, 2);
SELECT insereUsuario('Ana Flávia', '12121234344', '', 'ana@email.com', 'ana', 1, 3);
SELECT insereUsuario('Maria Clara', '77777788899', '', 'maria@email.com', 'maria', 1, 3);
...
INSERT INTO TipoTitulo(nome)
  VALUES ('A vista'), ('Parcelado');

INSERT INTO Categoria(nome)
  VALUES ('Mercado'), ('Posto de Combustível'), ('Loja de Departamentos'), ('Lanchonete');